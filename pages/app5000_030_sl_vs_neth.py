...
dash.register_page(__name__,name = 'MATCH 19 NETH VS SL')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('SRI LANKA VS NETHERLANDS', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.Br(),
                    html.H5("The Probability prediction of Sri Lanka winning the game after losing the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((47.1779)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((36.9432)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((51.0744)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Netherlands winning the game after Batting First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_action_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((37.8031)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((73.5068)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Netherlands winning the game after scoring "+str((runs_scored))+" Batting First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((first_innings_runs_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((42.1919)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
