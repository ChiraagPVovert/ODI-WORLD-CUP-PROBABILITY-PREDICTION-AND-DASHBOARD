...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('PARTNERSHIPS - 2015 ODI WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['PARTNERSHIP BY RUNS','PARTNERSHIP BY WICKETS'], id='request_partner_2015')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_partner_2015'),
                    html.Br(),
                    html.Div([], id='service_2_partner_2015')
...
@dash.callback(
    ...
    [
        Output('service_1_partner_2015','children'),
        Output('service_2_partner_2015','children'),
    ],
    ...
    [
        State("request_partner_2015", 'value'),
        State('service_1_partner_2015','children'),
        State('service_2_partner_2015','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    partnership_by_runs = pd.read_excel('assets/2015_World_Cup/highest_partnership_by_runs_2015.xlsx')
    partnership_by_wicket = pd.read_excel('assets/2015_World_Cup/highest_partnership_by_wickets_2015.xlsx')
    ...
    if need == 'PARTNERSHIP BY RUNS':
        ...
        partnership = partnership[['Partners','Runs','Wickets','Team','O/NO','Opposition','Ground']]
        partnership = pd.DataFrame(partnership)
        partnership_10 = partnership.head(10)
        df1_fig = dbc.Table.from_dataframe(partnership, striped=True, bordered=True, hover=True)

        fig_1 = px.bar(partnership_10, x='Partners', y='Runs',
                     hover_data=['Partners','Runs','Wickets','Team','Opposition','Ground'], color='Runs',
                     #labels={'pop': 'population of Canada'},
                     height=400)
        fig_1.update_layout(width=1200, height=500)
