...
dash.register_page(__name__,name = 'MATCH 31 PAK VS BAN')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('PAKISTAN VS BANGLADESH', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((46.7349)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((52.6263)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((46.632)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((57.6929)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
