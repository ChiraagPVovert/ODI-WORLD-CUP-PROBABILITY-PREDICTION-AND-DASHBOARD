...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('BATTING - 1992 ODI WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST RUNS', 'HIGHEST SCORERS IN AN INNINGS', 'BEST AVERAGE',
                                            ...
                                            'MOST RUNS FROM BOUNDARIES IN AN INNINGS'], id='request_bat_1992')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([],id='service_1_bat_1992'),
                    html.Br(),
                    html.Div([], id='service_2_bat_1992')
...
@dash.callback(
    ...
    [
        Output('service_1_bat_1992','children'),
        Output('service_2_bat_1992','children'),
    ],
    ...
    [
        State("request_bat_1992", 'value'),
        State('service_1_bat_1992','children'),
        State('service_2_bat_1992','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    batting = pd.read_excel('assets/1992_World_Cup/bat_most_runs_hs_avg_sr_bf_no_hund_fifties_ducks_sixes_fours_1992.xlsx')
    batting_in_an_innings = pd.read_excel('assets/1992_World_Cup/bat_most_runs_from_fours_sixes_in_an_innings_1992.xlsx')
    ...
    if need == 'MOST RUNS':
        ...
        batting_10 = batting.head(10)
        df1_fig = dbc.Table.from_dataframe(batting_data.head(39), striped=True, bordered=True, hover=True)
