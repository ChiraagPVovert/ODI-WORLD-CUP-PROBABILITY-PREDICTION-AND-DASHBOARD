...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('PARTNERSHIPS - 1987 ODI WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['PARTNERSHIP BY RUNS','PARTNERSHIP BY WICKETS'], id='request_partner_1987')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_partner_1987'),
                    html.Br(),
                    html.Div([], id='service_2_partner_1987')
...
@dash.callback(
    ...
    [
        Output('service_1_partner_1987','children'),
        Output('service_2_partner_1987','children'),
    ],
    ...
    [
        State("request_partner_1987", 'value'),
        State('service_1_partner_1987','children'),
        State('service_2_partner_1987','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    partnership_by_runs = pd.read_excel('assets/1987_World_Cup/highest_partnership_by_runs_1987.xlsx')
    partnership_by_wicket = pd.read_excel('assets/1987_World_Cup/highest_partnership_by_wickets_1987.xlsx')
