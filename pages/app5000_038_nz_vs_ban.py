...
dash.register_page(__name__,name = 'MATCH 11 NZ VS BAN')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('NEW ZEALAND VS BANGLADESH', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.Br(),
                    html.H5("The Probability prediction of New Zealand winning the game after winnning the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((58.8418)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((44.8569)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((56.6206)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((47.0255)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((69.2655)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((49.1262)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
