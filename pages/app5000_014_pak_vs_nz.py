...
dash.register_page(__name__,name = 'MATCH 35 PAK VS NZ')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('PAKSITAN VS NEW ZEALAND', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((58.6509)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((58.1718)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((56.7597)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((60.0255)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((35.0572)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((79.4213)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
