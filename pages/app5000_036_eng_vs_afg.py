...
dash.register_page(__name__,name = 'MATCH 13 ENG VS AFG')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('ENGLAND VS AFGHANISTAN', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((56.0704)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((37.5282)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((53.6886)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((39.699)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((74.2713)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((46.0981)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
