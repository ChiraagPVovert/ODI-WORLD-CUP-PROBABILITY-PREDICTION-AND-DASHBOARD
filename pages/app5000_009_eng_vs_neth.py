...
dash.register_page(__name__,name = 'MATCH 40 ENG VS NETH')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('ENGLAND VS NETHERLANDS', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((54.4556)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((36.0374)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((53.9513)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((36.5024)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
