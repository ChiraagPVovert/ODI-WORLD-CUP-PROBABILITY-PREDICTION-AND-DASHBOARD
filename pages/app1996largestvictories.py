...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('LARGEST VICTORIES - 1996 WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['LARGEST VICTORY BY RUNS', 'LARGEST VICTORY BY WICKETS'], id='request_victory_1996')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_victory_1996'),
                    html.Br(),
                    html.Div([], id='service_2_victory_1996')
...
@dash.callback(
    ...
    [
        Output('service_1_victory_1996','children'),
        Output('service_2_victory_1996','children'),
    ],
    ...
    [
        State("request_victory_1996", 'value'),
        State('service_1_victory_1996','children'),
        State('service_2_victory_1996','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    victory_by_wickets = pd.read_excel('assets/1996_World_Cup/largest_victories_by_wickets_1996.xlsx')
    victory_by_runs = pd.read_excel('assets/1996_World_Cup/largest_victories_by_runs_1996.xlsx')
