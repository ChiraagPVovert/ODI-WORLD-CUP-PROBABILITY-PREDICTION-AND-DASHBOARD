...
dash.register_page(__name__,name = 'MATCH 5 IND VS AUS')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('INDIA VS AUSTRALIA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.Br(),
                    html.H5("The Probability prediction of Australia winning the game after winning the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((69.6971)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((63.4983 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H3('AFTER CHOICE RESULTS PREDICTION', style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Australia winning the game after Batting First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_action_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((63.9262 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((69.5785 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((86.7453 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Australia winning the game after scoring "+str((runs_scored))+" Batting First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((first_innings_runs_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((57.1197 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
