...
dash.register_page(__name__,name = 'MATCH 28 NETH VS BAN')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('NETHERLANDS VS BANGLADESH', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((38.3222)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((44.3047)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((36.4609)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((46.2527)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((71.5399)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((35.3801)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
