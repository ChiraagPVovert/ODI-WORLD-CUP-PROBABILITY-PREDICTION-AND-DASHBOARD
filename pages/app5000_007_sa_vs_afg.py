...
dash.register_page(__name__,name = 'MATCH 42 SA VS AFG')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('AFGHANISTAN VS SOUTH AFRICA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.Br(),
                    html.H5("The Probability prediction of Afghanistan winning the game after winning the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((43.2306)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((49.0578)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((42.8221)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((50.0429)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    #html.H4(str((49.4973)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    #html.H4(str((68.376)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
