...
dash.register_page(__name__,name = 'MATCH 10 AUS VS SA')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('AUSTRALIA VS SOUTH AFRICA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.Br(),
                    html.H5("The Probability prediction of Australia winning the game after winnning the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((68.4665)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((54.519 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((64.8441)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((58.3198)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((55.8833)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((67.3131)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
