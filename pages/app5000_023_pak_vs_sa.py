...
dash.register_page(__name__,name = 'MATCH 26 PAK VS SA')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('PAKISTAN VS SOUTH AFRICA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((59.5814)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((47.7144)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((56.8504)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((50.0592)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((74.0613)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((60.0025)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
