...
dash.register_page(__name__,name = 'MATCH 20 ENG VS SA')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('ENGLAND VS SOUTH AFRICA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((54.771)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((54.4434)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((42.7712 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((73.9405)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
