...
dash.register_page(__name__,name = 'MATCH 44 ENG VS PAK ')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('ENGLAND VS PAKISTAN', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((53.4157)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((53.464)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((51.8154)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((55.1125)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((70.9556)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((67.8524)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
