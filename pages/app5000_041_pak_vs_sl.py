...
dash.register_page(__name__,name = 'MATCH 8 PAK VS SL')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('PAKISTAN VS SRI LANKA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.Br(),
                    html.H5("The Probability prediction of Pakistan winning the game after losing the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((54.5282)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Sri Lanka winning the game after winnning the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((53.5426 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H3('AFTER CHOICE RESULTS PREDICTION', style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Pakistan winning the game after Bowling First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_action_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((58.7129)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((49.4635)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H3('AFTER FIRST INNINGS RESULTS PREDICTION', style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Pakistan winning the game after taking "+str((wickets_taken))+" wickets Bowling first ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((first_innings_wickets_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((71.6039)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((63.2011)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
