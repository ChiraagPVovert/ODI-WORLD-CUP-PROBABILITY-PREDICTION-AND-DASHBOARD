...
dash.register_page(__name__, name = '1999 ODI WORLD CUP', order=1111111111000000)

df = pd.read_excel('assets/1999_World_Cup/points_table_1999.xlsx')
df = df.fillna(' ')
...
fig3 = go.Figure(data=[go.Pie(labels=df3.TEAMS, values=df2.POINTS, pull=[0, 0, 0, 0, 0, 0.2])])
...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('POINTS TABLE - 1999 ODI WORLD CUP', style={'textAlign': 'center'}),
                    html.Br(),
