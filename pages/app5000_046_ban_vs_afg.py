...
dash.register_page(__name__,name = 'MATCH 3 BAN VS AFG')

teams_values = {'Afghanistan': 10,
                'Bangladesh': 11,}
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('BANGLADESH VS AFGHANISTAN', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str(('34.1495')) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str(('47.609')) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str(('40.8133')) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Bangladesh winning the game after Bowling First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_action_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str(('42.7879')) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H3('AFTER FIRST INNINGS RESULTS PREDICTION', style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Bangladesh winning the game after taking "+str((wickets_taken))+" wickets Bowling first ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((first_innings_wickets_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str(('67.7505')) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str(('29.156')) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
