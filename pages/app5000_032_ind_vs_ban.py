...
dash.register_page(__name__,name = 'MATCH 17 IND VS BAN')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('INDIA VS BANGLADESH', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((67.5094)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Bangladesh winning the game after Winning the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((49.1151)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((70.5519)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Bangladesh winning the game after Batting First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_action_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((45.5321)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((74.4681)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Bangladesh winning the game after scoring "+str((runs_scored))+" Batting First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((first_innings_runs_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((50.2737)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
