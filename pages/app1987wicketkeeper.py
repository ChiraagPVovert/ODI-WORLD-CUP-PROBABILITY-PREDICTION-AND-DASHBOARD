...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('WICKET KEEPER - 1987 WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST DISMISSALS INVOLVING A WICKET KEEPER',
                                            'MOST DISMISSALS INVOLVING A WICKET KEEPER IN AN INNINGS'], id='request_wk_1987')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_wk_1987'),
                    html.Br(),
                    html.Div([], id='service_2_wk_1987')
...
@dash.callback(
        ...
        [
            Output('service_1_wk_1987', 'children'),
            Output('service_2_wk_1987', 'children'),
        ],
        ...
        [
            State("request_wk_1987", 'value'),
            State('service_1_wk_1987', 'children'),
            State('service_2_wk_1987', 'children'),
        ],
...
def output(n_clicks, need, o1, o2):
    ...
    wk = pd.read_excel('assets/1987_World_Cup/most_dismissals_by_wk_1987.xlsx')
    wk_innings = pd.read_excel('assets/1987_World_Cup/most_dismissals_in_an_innings_by_wk_1987.xlsx')
