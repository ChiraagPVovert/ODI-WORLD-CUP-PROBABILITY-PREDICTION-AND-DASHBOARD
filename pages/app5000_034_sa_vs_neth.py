...
dash.register_page(__name__,name = 'MATCH 15 SA VS NETH')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('SOUTH AFRICA VS NETHERLANDS', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.Br(),
                    html.H5("The Probability prediction of South Africa winning the game after winning the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((62.7853)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Netherlands winning the game after losing the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((20.144)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H3('AFTER CHOICE RESULTS PREDICTION', style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of South Africa winning the game after Bowling First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_action_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((60.4347)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((23.2071)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H3('AFTER FIRST INNINGS RESULTS PREDICTION', style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of South Africa winning the game after taking "+str((wickets_taken))+" wickets Bowling first ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((first_innings_wickets_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((62.2084)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((28.2597)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
