...
dash.register_page(__name__,name = 'MATCH 23 SA VS BAN')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('SOUTH AFRICA VS BANGLADESH', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((52.8487)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Bangladesh winning the game after losing the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((45.157)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((50.8223)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((47.9995)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((19.9301)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((67.6825)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
