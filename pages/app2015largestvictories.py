...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('LARGEST VICTORIES - 2015 WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['LARGEST VICTORY BY RUNS', 'LARGEST VICTORY BY WICKETS'], id='request_victory_2015')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_victory_2015'),
                    html.Br(),
                    html.Div([], id='service_2_victory_2015')
...
@dash.callback(
    ...
    [
        Output('service_1_victory_2015','children'),
        Output('service_2_victory_2015','children'),
    ],
    ...
    [
        State("request_victory_2015", 'value'),
        State('service_1_victory_2015','children'),
        State('service_2_victory_2015','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    victory_by_wickets = pd.read_excel('assets/2015_World_Cup/largest_victories_by_wickets_2015.xlsx')
    victory_by_runs = pd.read_excel('assets/2015_World_Cup/largest_victories_by_runs_2015.xlsx')
