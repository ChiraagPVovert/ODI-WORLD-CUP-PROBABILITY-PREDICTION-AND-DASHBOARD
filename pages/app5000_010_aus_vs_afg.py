...
dash.register_page(__name__,name = 'MATCH 39 AUS VS AFG')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('AFGHANISTAN VS AUSTRALIA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((45.0196)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((61.5366)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((43.5855)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((63.1364)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((32.5846)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((51.7756)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
