...
dash.register_page(__name__,name = 'MATCH 21 IND VS NZ')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('INDIA VS NEW ZEALAND', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((70.5021)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((60.0457)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((69.4457)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((62.0378)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((87.4546)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((65.2105)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
