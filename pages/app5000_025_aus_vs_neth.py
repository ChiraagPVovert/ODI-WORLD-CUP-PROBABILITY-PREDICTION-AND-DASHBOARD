...
dash.register_page(__name__,name = 'MATCH 24 AUS VS NETH')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('AUSTRALIA VS NETHERLANDS', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((65.1771)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((35.239)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((63.1147)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((37.4443)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((37.7218)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((81.2241)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
