...
def initialize_data(year):
    ...
    batsman_df[['NO_OF_MATCHES_PLAYED', 'RUNS', 'BATTING_AVG', 'BATTING_STRIKE_RATE', 'RECENTLY_PLAYING_IN_ODI']] = \
        batsman_df[
            ['NO_OF_MATCHES_PLAYED', 'RUNS', 'BATTING_AVG', 'BATTING_STRIKE_RATE', 'RECENTLY_PLAYING_IN_ODI']].astype(
            float)
    # batsman_df.info()
...
def model_predictions(team, year):
    ...
    batsman_and_wk_df = batsman_and_wk_df[
        ['PLAYERS', 'NO_OF_MATCHES_PLAYED', 'RUNS', 'BATTING_AVG', 'BATTING_STRIKE_RATE']].copy()
...
# prob = model_predictions('BANGLADESH',2022)
