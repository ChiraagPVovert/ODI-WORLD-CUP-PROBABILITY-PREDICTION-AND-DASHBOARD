...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('BATTING - 2019 ODI WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST RUNS', 'HIGHEST SCORERS IN AN INNINGS', 'BEST AVERAGE',
                                            ...
                                            'MOST RUNS FROM BOUNDARIES IN AN INNINGS'], id='request_bat_2019')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([],id='service_1_bat_2019'),
                    html.Br(),
                    html.Div([], id='service_2_bat_2019')
...
@dash.callback(
    ...
    [
        Output('service_1_bat_2019','children'),
        Output('service_2_bat_2019','children'),
    ],
    ...
    [
        State("request_bat_2019", 'value'),
        State('service_1_bat_2019','children'),
        State('service_2_bat_2019','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    batting = pd.read_excel('assets/2019_World_Cup/bat_most_runs_hs_avg_sr_bf_no_hund_fifties_ducks_sixes_fours_2019.xlsx')
    batting_in_an_innings = pd.read_excel('assets/2019_World_Cup/bat_most_runs_from_fours_sixes_in_an_innings_2019.xlsx')
