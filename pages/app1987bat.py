...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('BATTING - 1987 ODI WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST RUNS', 'HIGHEST SCORERS IN AN INNINGS', 'BEST AVERAGE',
                                            ...
                                            'MOST RUNS FROM BOUNDARIES IN AN INNINGS'], id='request_bat_1987')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([],id='service_1_bat_1987'),
                    html.Br(),
                    html.Div([], id='service_2_bat_1987')
...
@dash.callback(
    ...
    [
        Output('service_1_bat_1987','children'),
        Output('service_2_bat_1987','children'),
    ],
    ...
    [
        State("request_bat_1987", 'value'),
        State('service_1_bat_1987','children'),
        State('service_2_bat_1987','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    batting = pd.read_excel('assets/1987_World_Cup/bat_most_runs_hs_avg_sr_bf_no_hund_fifties_ducks_sixes_fours_1987.xlsx')
    batting_in_an_innings = pd.read_excel('assets/1987_World_Cup/bat_most_runs_from_fours_sixs_in_an_innings_1987.xlsx')
