...
dash.register_page(__name__,name = 'MATCH 12 IND VS PAK')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('INDIA VS PAKISTAN', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((72.5509)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((61.9462 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((70.4828 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((64.3822)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((86.5907)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((60.2058)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
