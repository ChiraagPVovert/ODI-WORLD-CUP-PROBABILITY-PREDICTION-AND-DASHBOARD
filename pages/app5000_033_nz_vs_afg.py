...
dash.register_page(__name__,name = 'MATCH 16 NZ VS AFG')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('NEW ZEALAND VS AFGHANISTAN', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((43.3612)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((51.7554)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((41.5809)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((53.4907 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((22.6042 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((60.8926)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
