...
dash.register_page(__name__,name = 'MATCH 18 AUS VS PAK')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('AUSTRALIA VS PAKISTAN', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((68.6031)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((60.5943)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((68.0192)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((61.1197)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((78.19)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((77.42)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
