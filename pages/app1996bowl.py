    ...
    return html.Div([
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        html.H3('BOWLING - 1996 ODI WORLD CUP', style={'textAlign': 'center'}),
                        html.Br(),
                        html.Div([dcc.Dropdown(['MOST WICKETS', 'MOST OVERS BOWLED', 'MOST MAIDEN OVERS BOWLED',
                                                ...
                                                'BEST ECONOMY IN AN INNINGS'], id='request_bowl_1996')]),
                        html.Br(),
                        html.Div(
                            [
                        ...
                        html.Br(),
                        html.Div([], id='service_1_bowl_1996'),
                        html.Br(),
                        html.Div([], id='service_2_bowl_1996')
...
@dash.callback(
    ...
    [
        Output('service_1_bowl_1996', 'children'),
        Output('service_2_bowl_1996', 'children'),
    ],
    ...
    [
        State("request_bowl_1996", 'value'),
        State('service_1_bowl_1996', 'children'),
        State('service_2_bowl_1996', 'children'),
    ],
...
def output(n_clicks, need, o1, o2):
    bowling = pd.read_excel('assets/1996_World_Cup/bowl_wkts_avg_econ_sr_4w_5w_bbi_1996.xlsx')
    bowling_in_an_innings = pd.read_excel('assets/1996_World_Cup/bowl_innings_wkts_econ_runsconc_sr_1996.xlsx')
    ...
    if need == 'MOST WICKETS':
        ...
        bowling_10 = bowling.iloc[22:].head(10)
        df1_fig = dbc.Table.from_dataframe(bowling.iloc[22:], striped=True, bordered=True, hover=True)
