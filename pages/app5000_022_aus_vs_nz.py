...
dash.register_page(__name__,name = 'MATCH 27 AUS VS NZ')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('AUSTRALIA VS NEW ZEALAND', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((62.756)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((60.9058)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((60.1672)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((63.3933)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((82.3007)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((80.1668)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
