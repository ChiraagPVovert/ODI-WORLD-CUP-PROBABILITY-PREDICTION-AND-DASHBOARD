...
dash.register_page(__name__, name = '2015 ODI WORLD CUP', order=1111111111111100)

df = pd.read_excel('assets/2015_World_Cup/points_table_2015.xlsx')
df = df.fillna(' ')
...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('POINTS TABLE - 2015 ODI WORLD CUP', style={'textAlign': 'center'}),
                    html.Br(),
