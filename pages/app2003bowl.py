    ...
    return html.Div([
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        html.H3('BOWLING - 2003 ODI WORLD CUP', style={'textAlign': 'center'}),
                        html.Br(),
                        html.Div([dcc.Dropdown(['MOST WICKETS', 'MOST OVERS BOWLED', 'MOST MAIDEN OVERS BOWLED',
                                                ...
                                                'BEST ECONOMY IN AN INNINGS'], id='request_bowl_2003')]),
                        html.Br(),
                        html.Div(
                            [
                        ...
                        html.Br(),
                        html.Div([], id='service_1_bowl_2003'),
                        html.Br(),
                        html.Div([], id='service_2_bowl_2003')
...
@dash.callback(
    ...
    [
        Output('service_1_bowl_2003', 'children'),
        Output('service_2_bowl_2003', 'children'),
    ],
    ...
    [
        State("request_bowl_2003", 'value'),
        State('service_1_bowl_2003', 'children'),
        State('service_2_bowl_2003', 'children'),
    ],
...
def output(n_clicks, need, o1, o2):
    bowling = pd.read_excel('assets/2003_World_Cup/bowl_wkts_avg_econ_sr_4w_5w_bbi_2003.xlsx')
    bowling_in_an_innings = pd.read_excel('assets/2003_World_Cup/bowl_innings_wkts_econ_runsconc_sr_2003.xlsx')
    ...
    if need == 'MOST WICKETS':
        ...
        bowling_10 = bowling.iloc[19:].head(10)
        df1_fig = dbc.Table.from_dataframe(bowling_data.iloc[19:], striped=True, bordered=True, hover=True)
