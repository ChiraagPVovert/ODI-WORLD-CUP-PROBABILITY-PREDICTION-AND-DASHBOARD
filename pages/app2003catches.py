...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('CATCHES - 2003 ODI WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST CATCHES BY A FIELDER (EXCLUDING WICKET KEEPER)',
                                            'MOST CATCHES IN AN INNINGS BY A FIELDER (EXCLUDING WICKET KEEPER)'], id='request_catch_2003')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_catch_2003'),
                    html.Br(),
                    html.Div([], id='service_2_catch_2003')
...
@dash.callback(
    ...
    [
        Output('service_1_catch_2003','children'),
        Output('service_2_catch_2003','children'),
    ],
    ...
    [
        State("request_catch_2003", 'value'),
        State('service_1_catch_2003','children'),
        State('service_2_catch_2003','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    catches = pd.read_excel('assets/2003_World_Cup/most_catches_2003.xlsx')
    catches_in_an_innings = pd.read_excel('assets/2003_World_Cup/most_catches_in_an_innings_2003.xlsx')
