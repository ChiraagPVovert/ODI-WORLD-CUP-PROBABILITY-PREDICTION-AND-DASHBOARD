...
dash.register_page(__name__,name = 'MATCH 36 ENG VS AUS')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('ENGLAND VS AUSTRALIA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((54.6594)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((59.7138)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((52.3586)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((61.9151)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((76.4292)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((68.6475)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
