...
dash.register_page(__name__,name = 'MATCH 6 NZ VS NETH')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('NEW ZEALAND VS NETHERLANDS', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.Br(),
                    html.H5("The Probability prediction of Netherlands winning the game after winning the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((42.5908)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of New Zealand winning the game after losing the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((56.212 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H3('AFTER CHOICE RESULTS PREDICTION', style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Netherlands winning the game after Bowling First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team2_action_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((39.5396)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of New Zealand winning the game after Batting First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_action_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((59.2969 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H3('AFTER FIRST INNINGS RESULTS PREDICTION', style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of Netherlands winning the game after taking "+str((wickets_taken))+" wickets Bowling first ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((first_innings_wickets_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((28.0384 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of New Zealand winning the game after scoring "+str((runs_scored))+" Batting First ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((first_innings_runs_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((68.8624 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
