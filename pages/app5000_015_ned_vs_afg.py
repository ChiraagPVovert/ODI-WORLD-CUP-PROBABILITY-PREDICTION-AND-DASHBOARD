...
dash.register_page(__name__,name = 'MATCH 34 NETH VS AFG')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('NETHERLANDS VS AFGHANISTAN', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((38.277)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((41.1047)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((36.9397)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((43.3926)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((68.0022)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((28.827)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
