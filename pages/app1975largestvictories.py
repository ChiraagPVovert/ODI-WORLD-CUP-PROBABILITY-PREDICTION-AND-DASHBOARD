...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('LARGEST VICTORIES - 1975 WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['LARGEST VICTORY BY RUNS', 'LARGEST VICTORY BY WICKETS'], id='request_victory')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_victory'),
                    html.Br(),
                    html.Div([], id='service_2_victory')
...
@dash.callback(
    ...
    [
        Output('service_1_victory','children'),
        Output('service_2_victory','children'),
    ],
    ...
    [
        State("request_victory", 'value'),
        State('service_1_victory','children'),
        State('service_2_victory','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    victory_by_wickets = pd.read_excel('assets/1975_World_Cup/largest_victories_by_wickets_1975.xlsx')
    victory_by_runs = pd.read_excel('assets/1975_World_Cup/largest_victories_by_runs_1975.xlsx')
    ...
    if need == 'LARGEST VICTORY BY RUNS':
        ...
        #df1_fig = ff.create_table(victory_by_runs, index=False)
    ...
    if need == 'LARGEST VICTORY BY WICKETS':
        ...
        #df1_fig = ff.create_table(victory_by_wickets, index=False)
