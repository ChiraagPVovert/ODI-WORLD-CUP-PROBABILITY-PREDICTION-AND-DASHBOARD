...
dash.register_page(__name__,name = 'MATCH 37 IND VS SA')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('INDIA VS SOUTH AFRICA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.Br(),
                    html.H5("The Probability prediction of India winning the game after winning the toss ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((team1_win_toss)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((67.1758)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((48.9194)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((67.4625)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((50.5167)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((19.6894)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((74.7192)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
