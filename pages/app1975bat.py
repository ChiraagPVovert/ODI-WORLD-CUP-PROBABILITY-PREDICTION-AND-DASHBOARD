...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('BATTING - 1975 ODI WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST RUNS', 'HIGHEST SCORERS IN AN INNINGS', 'BEST AVERAGE',
                                            ...
                                            'MOST RUNS FROM BOUNDARIES IN AN INNINGS'], id='request_bat')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([],id='service_1_bat'),
                    html.Br(),
                    html.Div([], id='service_2_bat')
...
@dash.callback(
    ...
    [
        Output('service_1_bat','children'),
        Output('service_2_bat','children'),
    ],
    ...
    [
        State("request_bat", 'value'),
        State('service_1_bat','children'),
        State('service_2_bat','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    batting = pd.read_excel('assets/1975_World_Cup/bat_most_runs_hs_avg_sr_bf_no_hund_fifties_ducks_sixes_fours_1975.xlsx')
    batting_in_an_innings = pd.read_excel('assets/1975_World_Cup/bat_most_runs_from_fours_and_sixes_in_an_innings_1975.xlsx')
    ...
    if need == 'MOST RUNS':
        ...
        batting_10 = batting.head(5)
        df1_fig = dbc.Table.from_dataframe(batting_data.head(5), striped=True, bordered=True, hover=True)
