...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('PARTNERSHIPS - 2007 ODI WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['PARTNERSHIP BY RUNS','PARTNERSHIP BY WICKETS'], id='request_partner_2007')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_partner_2007'),
                    html.Br(),
                    html.Div([], id='service_2_partner_2007')
...
@dash.callback(
    ...
    [
        Output('service_1_partner_2007','children'),
        Output('service_2_partner_2007','children'),
    ],
    ...
    [
        State("request_partner_2007", 'value'),
        State('service_1_partner_2007','children'),
        State('service_2_partner_2007','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    partnership_by_runs = pd.read_excel('assets/2007_World_Cup/highest_partnership_by_runs_2007.xlsx')
    partnership_by_wicket = pd.read_excel('assets/2007_World_Cup/highest_partnership_by_wickets_2007.xlsx')
