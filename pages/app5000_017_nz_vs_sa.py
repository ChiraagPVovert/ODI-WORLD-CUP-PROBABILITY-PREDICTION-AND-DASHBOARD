...
dash.register_page(__name__,name = 'MATCH 32 NZ VS SA')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('NEW ZEALAND VS SOUTH AFRICA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((61.219)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((48.0494)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((61.0043)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((50.3424)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.H3('AFTER FIRST INNINGS RESULTS PREDICTION', style={'textAlign': 'center'}),
                    html.Br(),
                    html.H5("The Probability prediction of New Zealanad winning the game after taking "+str((wickets_taken))+" wickets Bowling first ", style={'textAlign':'center'}),
                    html.Br(),
                    #html.H4(str((first_innings_wickets_win)) + " %", style={'textAlign': 'center'}),
                    html.H4(str((18.8527)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((66.6404 )) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
