...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('CATCHES - 2015 ODI WORLD CUP', style={'textAlign':'center'}),
                    html.Br(),
                    html.Div([dcc.Dropdown(['MOST CATCHES BY A FIELDER (EXCLUDING WICKET KEEPER)',
                                            'MOST CATCHES IN AN INNINGS BY A FIELDER (EXCLUDING WICKET KEEPER)'], id='request_catch_2015')]),
                    html.Br(),
                    html.Div(
                        [
                    ...
                    html.Br(),
                    html.Div([], id='service_1_catch_2015'),
                    html.Br(),
                    html.Div([], id='service_2_catch_2015')
...
@dash.callback(
    ...
    [
        Output('service_1_catch_2015','children'),
        Output('service_2_catch_2015','children'),
    ],
    ...
    [
        State("request_catch_2015", 'value'),
        State('service_1_catch_2015','children'),
        State('service_2_catch_2015','children'),
    ],
...
def output(n_clicks,need,o1,o2):
    ...
    catches = pd.read_excel('assets/2015_World_Cup/most_catches_2015.xlsx')
    catches_in_an_innings = pd.read_excel('assets/2015_World_Cup/most_catches_in_an_innings_2015.xlsx')
