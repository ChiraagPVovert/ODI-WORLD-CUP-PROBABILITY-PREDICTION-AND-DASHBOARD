...
dash.register_page(__name__, name = '1979 ODI WORLD CUP', order=1111100000000000)

df = pd.read_excel('assets/1979_World_Cup/points_table_1979.xlsx')
df = df.fillna(' ')
df1 = df[:4]
...
def layout():
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.H3('POINTS TABLE - 1979 ODI WORLD CUP', style={'textAlign': 'center'}),
                    html.Br(),
