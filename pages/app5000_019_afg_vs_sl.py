...
dash.register_page(__name__,name = 'MATCH 30 AFG VS SL')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('AFGHANISTAN VS SRI LANKA', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((47.744)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((45.9763)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((50.4066)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((43.2366)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((66.5202)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((50.7611)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
