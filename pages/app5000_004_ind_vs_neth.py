...
dash.register_page(__name__,name = 'MATCH 45 IND VS NETH ')
    ...
    dbc.Row(
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.H2('INDIA VS NETHERLANDS', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((69.782)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((34.6917)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((67.8885)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((37.2109)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
